// LAB 3 
// GOALS:
// -Be able to set up and adjust chart options using the Highcharts API documentation (available at: http://api.highcharts.com/highcharts)
...
//PART 1: SET UP CHART OPTIONS & GENERATE USING INLINE DATA
	var options = {
        ...
        //set chart title and subtitle and align center
        title: {
            text: 'First Chart',
            align: 'center'
        },
        ...
        legend: {
            //fill in the legend variables for layout and alignment so that you have a vertical legend on the right side of your graph
            layout: 'vertical',
            align: 'right',
    ...
    /*Once you have the code above working and generating a chart, comment out the var chart line directly above here and uncomment the code below to load the data from the csv using AJAX. You will need to follow the instructions in the code below to fill in this code and pull in the data. Delete the "/*" at the beginning of the next line and the "* /" at the bottom of the code to get started.*/
    ...
    $.get("_data/data.csv", function (data) {
        ...
        $.each(lines, function ( lineNo, line ) {
            ...
            if (lineNo == 0) {
                ...
                //Add code here to set the first value in the items array to seriesData.name
